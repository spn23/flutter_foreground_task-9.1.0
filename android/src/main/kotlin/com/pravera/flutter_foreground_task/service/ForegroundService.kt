// kotlin
// File: android/src/main/kotlin/com/pravera/flutter_foreground_task/service/ForegroundService.kt
...
class ForegroundService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        // remove use of deleteIntent to prevent dismissal via delete action
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // intentionally do NOT set a deleteIntent so the user cannot dismiss by delete action
            ...
            // ensure flags prevent user from clearing the ongoing notification
